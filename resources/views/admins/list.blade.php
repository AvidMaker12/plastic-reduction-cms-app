                ...
                <?php foreach($users as $user): ?>
                    <?php if($user->is_admin == 1): ?>
                        <tr>
                            ...
                            <td>
                                <a href="<?= route('admin.image',[$user->id]) ?>" class="btn btn-primary mb-1" role="button">{{ __('Profile Picture') }}</a>
                                <a href="<?= route('admin.edit',[$user->id]) ?>" class="btn btn-primary mb-1" role="button">{{ __('Edit') }}</a>
