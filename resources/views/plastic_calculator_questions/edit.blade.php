    ...
    <section class="container">
        ...
        <div class="card">
            <div class="card-header">
                <h2 class="card-title">{{ __('Edit Plastic Calculator Question') }}</h2>
            </div>
            ...
            <div class="card-body">
                <form method="post" action="<?= route('plastic_calculator_question.edit',[$plastic_calculator_question->id])?>" novalidate class="form-horizontal" enctype="multipart/form-data">
                    ...
                    <div class="mb-4">
                        ...
                        <input type="text" name="question" id="question" value="<?= old('question', $plastic_calculator_question->question) ?>" required class="form-control">
                    ...
                    <button type="submit" class="btn btn-success mb-3">{{ __('Edit Plastic Calculator Question') }}</button>
