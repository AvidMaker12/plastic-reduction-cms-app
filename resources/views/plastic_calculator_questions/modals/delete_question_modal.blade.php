<div class="modal fade" id="modalDeleteQuestion{{ $question->id }}" data-bs-backdrop="static" data-bs-keyboard="false" aria-hidden="true" area-labelledby="modalDeleteQuestionTitle{{ $question->id }}" tabindex="-1">
    <div class="modal-dialog modal-dialog-centered" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h4 class="modal-title" id="modalDeleteQuestionTitle{{ $question->id }}" >{{ __('Confirm Delete Plastic Calculator Question') }}</h4>
